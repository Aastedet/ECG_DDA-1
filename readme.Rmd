...
To save space and computation time, we filter the ECGs to only the ones we need, and export them to different folders for labelling purposes.
...
# Healthy:
file_copy(path = cded_healthy, new_path = here("ecg_data", "healthy"), overwrite = T)
file_copy(path = cpd_healthy, new_path = here("ecg_data", "healthy"), overwrite = T)

# Neuropathy:
file_copy(path = cded_neuropathy, new_path = here("ecg_data", "neuropathy"), overwrite = T)
file_copy(path = cpd_neuropathy, new_path = here("ecg_data", "neuropathy"), overwrite = T)
